...
import ex3.LinkedListMult;

public class LinkedToSet<E> implements Set<E> {
    private LinkedListMult<E> multiSet;

    public LinkedToSet(LinkedListMult<E> multiSet) {
    ...
    public static void main(String[] args) {
        LinkedListMult<String> multiSet = new LinkedListMult<>();
        multiSet.add("apple");
        multiSet.add("apple");
        multiSet.add("banana");

        Set<String> set = new LinkedToSet<>(multiSet);
