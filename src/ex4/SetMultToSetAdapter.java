...
import ex3.SetListMult;

public class SetMultToSetAdapter<E> implements Set<E> {
    private SetListMult<E> multiset;

    public SetMultToSetAdapter(SetListMult<E> multiset) {
    ...
    public static void main(String[] args) {
        SetListMult<String> multiset = new SetListMult<>();
        multiset.add("apple");
        multiset.add("apple");
        multiset.add("banana");

        Set<String> set = new SetMultToSetAdapter<>(multiset);
